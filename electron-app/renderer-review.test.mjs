...
function fixture() {
  ...
  vm.runInContext(controller+`;globalThis.testReview={setReviewVideo,selectReviewPage,currentReviewPage,selection:()=>reviewSelection,context:()=>pendingCandidateContext};`,context);

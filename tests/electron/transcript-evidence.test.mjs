...
import { omissionEvidence } from '../../electron-app/shared/transcript-evidence.mjs';
import { findingExcerpt, findingSeek, findingStatus, voiceFindingReason,
  completionFindings, completionSummary, findingKeyOf } from '../../electron-app/renderer/view-utils.mjs';
import { combineChapterReports } from '../../electron-app/shared/index.mjs';

const {finding, page} = JSON.parse(fs.readFileSync(new URL('../fixtures/ch02-l04-omission.json', import.meta.url)));
